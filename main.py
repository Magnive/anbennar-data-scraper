...
DEFINES['OUTPUT'] = True # Should always be false if the above is false.
DEFINES['ORIGIN_PATH'] = os.getcwd()
DEFINES['MAIN_PATH'] = r'C:\Users\Peter\Documents\Paradox Interactive\Europa Universalis IV\mod\anbennar-eu4-ovdal-tungr-build'
