...
def load_countries(path):
    ...
    for country_file in os.listdir():
        ...
        if 'religion' in country_info and 'primary_culture' in country_info and country_tag not in exclude_tags:
            ...
            with open(file_name, 'r', encoding = 'latin-1') as f:
                ...
                for line in lines:
                    if not history:
                        ...
                        elif 'construction' in key: # Someone added core construction to a file.
                            pass
